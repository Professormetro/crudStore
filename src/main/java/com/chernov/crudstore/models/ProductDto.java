package com.chernov.crudstore.models;
...
public class ProductDto {
    ...
    @Size(min = 10, message = "The description should be at least 10 chars")
    ...
    public @Size(min = 10, message = "The description should be at least 10 chars") @Size(max = 2000, message = "The description cannot exceed 2000 chars") String getDescription() {
        return description;
    }

    public void setDescription(@Size(min = 10, message = "The description should be at least 10 chars") @Size(max = 2000, message = "The description cannot exceed 2000 chars") String description) {
